class Translation(object):
    START_TEXT = """Hi {},
I'm TeleRoid-URL-Uploader!
You can upload HTTP/HTTPS direct link, Using this bot!
If You face any Problem contact @TeleRoid14
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @TheTeleRoid"
...
📌 Send url (example.domain/File.mp4 | New Filename.mp4).
📌 Send Image As Custom Thumbnail (Optional).
📌 Select the button.
...
If bot didn't respond, contact @TheTeleRoid"""
